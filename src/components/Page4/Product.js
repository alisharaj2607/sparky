...
import candle1 from "../../assets/bulb-1.png";
import candle2 from "../../assets/bulb-2.png";
import candle3 from "../../assets/bulb-3.png";
import candleBig from "../../assets/bulb-big.png";
...
const Product = () => {
  ...
  <div class="card-body">
    <h5 class="card-title">Holiday Time 600-Count Clear Mini Christmas Lights, with Green Wire, 125 feet</h5>
    <div class="star-row">
    ...
    <p class="product-price"><b class="bold-price">$12.00</b></p>
    ...
    <div className="flex flex-row gap-3">
      ...
      <div className="card-small" style={{ width: '13.5rem', height: 'auto' }}>
        <div class="card-body">
          ...
          <p class = "small-text2" style={{ marginLeft: '73px'}}><b>$12.00</b></p>
          <p class = "small-text3" style={{ marginLeft: '69px'}}><b>$4.00/p</b></p>
        </div>
      </div>
      ...
      <div class="card-body">
          ...
          <p class = "small-text2" style={{ marginLeft: '40px'}}><b>$12.00</b></p>
          <p class = "small-text3" style={{ marginLeft: '37px'}}><b>$4.00/p</b></p>
        </div>
