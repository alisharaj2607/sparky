 ...
 const Sparky = () => {
     ...
     return(
         ...
         <div>
            ...
            {isVisible && <Hidden text1={"These product reviews are mixed. Some customers love the bright and sturdy lights that work perfectly for their Christmas tree or outdoor decoration, while others had issues with the lights not working, blowing out, and wasting their time and money. Some customers found the lights affordable and easy to use, while others regretted not spending extra to buy better-quality lights. Overall, these lights have their pros and cons, and customers should carefully consider their needs and expectations before making a purchase."} text2={"Mixed"}  />}
         </div>
     );
 };
