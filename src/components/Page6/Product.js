...
import candle1 from "../../assets/hair-1.png";
import candle2 from "../../assets/hair-2.png";
import candle3 from "../../assets/hair-3.png";
import candleBig from "../../assets/hair-big.png";
...
const Product = () => {
  ...
  <div class="card-body">
    <h5 class="card-title">KIPOZI Professional Negative Ion Hair Straightener, Anti-Static Flat Iron with Floating Titanium Plates, 1 Inch, Pink</h5>
    <div class="star-row">
    ...
    <p class="product-price"><b class="bold-price">$26.99</b></p>
    ...
    <p class = "product-text py-3"><b>Actual Color:&ensp;</b>Pink, Black</p>
    <div className="flex flex-row gap-3">
      
      <div className="card-small" style={{ width: '13.5rem', height: 'auto' }}>
        <div class="card-body">
          <p class = "small-text"><b>Black, Dark Blue, Dark Green</b></p>
          <p class = "small-text2" style={{ marginLeft: '73px'}}><b>$26.99</b></p>
          <p class = "small-text3" style={{ marginLeft: '69px'}}><b>$64.00/3p</b></p>
        </div>
      </div>
      ...
      <div class="card-body">
          <p class = "small-text"><b>Pink, Black</b></p>
          <p class = "small-text2" style={{ marginLeft: '40px'}}><b>$26.99</b></p>
          <p class = "small-text3" style={{ marginLeft: '37px'}}><b>$64.00/3p</b></p>
        </div>
