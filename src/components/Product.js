...
import candle1 from "../assets/candle_1.png";
import candle2 from "../assets/candle_2.png";
import candle3 from "../assets/candle_3.png";
import candle4 from "../assets/candle_4.png";
import candle5 from "../assets/candle_5.png";
import candleBig from "../assets/candle_big.png";
...
const Product = () => {
    return (
      <div className="px-8 justify-between flex items-center" style={{ marginLeft: '200px', marginRight: '200px' }}>
        ...
        <div className="flex flex-col gap-2" >
            ...
            <img src={candle4} alt="" className=" h-30 w-30" />
            <img src={candle5} alt="" className=" h-30 w-30" />
        </div>
        {/* Middle */}
  ...
  <div class="card-body">
    <h5 class="card-title">Better Homes & Gardens Unscented Pillar Candles, 3-Pack, 3x5 inches, Orange, Pink, Red</h5>
    <div class="star-row">
    ...
    <p class="product-price"><b class="bold-price">$18.87</b>$6.29/ea</p>
    ...
    <div className="flex flex-row gap-3">
      ...
      <div className="card-small" style={{ width: '13.5rem', height: 'auto' }}>
        <div class="card-body">
          ...
          <p class = "small-text2" style={{ marginLeft: '73px'}}><b>$18.87</b></p>
          <p class = "small-text3" style={{ marginLeft: '64px'}}><b>$6.29/ea</b></p>
        </div>
      </div>
      ...
      <div class="card-body">
          ...
          <p class = "small-text2" style={{ marginLeft: '40px'}}><b>$18.87</b></p>
          <p class = "small-text3" style={{ marginLeft: '32px'}}><b>$6.29/ea</b></p>
        </div>
