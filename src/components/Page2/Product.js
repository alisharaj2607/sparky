...
import candle1 from "../../assets/icecream-1.png";
import candle2 from "../../assets/icecream-2.png";
import candle3 from "../../assets/icecream-3.png";
import candleBig from "../../assets/icecream-big.png";
...
const Product = () => {
  ...
  <div class="card-body">
    <h5 class="card-title">Cuisinart Ice Cream/Yogurt Makers Mix It In™ Soft Serve Ice Cream Maker</h5>
    <div class="star-row">
    ...
    <p class="product-price"><b class="bold-price">$129.95</b></p>
    ...
    <div className="flex flex-row gap-3">
      ...
      <div className="card-small" style={{ width: '13.5rem', height: 'auto' }}>
        <div class="card-body">
          ...
          <p class = "small-text2" style={{ marginLeft: '73px'}}><b>$129.95</b></p>
          <p class = "small-text3" style={{ marginLeft: '69px'}}><b>$6.29/ea</b></p>
        </div>
      </div>
      ...
      <div class="card-body">
          ...
          <p class = "small-text2" style={{ marginLeft: '40px'}}><b>$129.95</b></p>
          <p class = "small-text3" style={{ marginLeft: '37px'}}><b>$6.29/ea</b></p>
        </div>
