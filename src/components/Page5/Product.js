...
import candle1 from "../../assets/box-1.png";
import candle2 from "../../assets/box-2.png";
import candle3 from "../../assets/box-3.png";
import candleBig from "../../assets/box-big.png";
...
const Product = () => {
    return (
      <div className="px-8 justify-between flex items-center" style={{ marginLeft: '200px', marginRight: '200px' }}>
        ...
        {/* Right */} 
        <div>
        <div className="card" style={{ width: '26rem', height: '775px' }}>
  <div class="card-body">
    <h5 class="card-title">Ktaxon Wooden Bathroom Floor Storage Cabinet with 4 Drawers,Free Standing Bathroom Storage Organizer Unit for Entryway Kitchen Bedroom Living Room, White Finish</h5>
    <div class="star-row">
    ...
    <p class="product-price"><b class="bold-price">$69.99</b></p>
    ...
    <p class = "product-text py-3"><b>Actual Color:&ensp;</b>Cream, white</p>
    <div className="flex flex-row gap-3">
      
      <div className="card-small" style={{ width: '13.5rem', height: 'auto' }}>
        <div class="card-body">
          <p class = "small-text"><b>Black, Dark Blue, Dark Green</b></p>
          <p class = "small-text2" style={{ marginLeft: '73px'}}><b>$69.99</b></p>
          <p class = "small-text3" style={{ marginLeft: '69px'}}><b>$84.00/p</b></p>
        </div>
      </div>
      ...
      <div class="card-body">
          <p class = "small-text"><b>Cream, white</b></p>
          <p class = "small-text2" style={{ marginLeft: '40px'}}><b>$69.99</b></p>
          <p class = "small-text3" style={{ marginLeft: '37px'}}><b>$84.00/p</b></p>
        </div>
